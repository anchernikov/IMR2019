(***************************************************************)
(*                                                             *)
(*  Coq script (certificate) accompanying IMR paper            *)
...
Section Segment_Point_Not_Intersecting_1D.
  Variables c a b : BCoord.
  Inductive SPNI1D : Prop :=
  | SPNI1D_1 : BelowSymm c a b -> SPNI1D
  | SPNI1D_2 : AboveSymm c a b -> SPNI1D.
End Segment_Point_Not_Intersecting_1D.

Section Segment_Point_Not_Intersecting_3D.
...
End Segment_Point_Not_Intersecting_3D.

Section Segment_Segment_Not_Intersecting_1D.
...
End Segment_Segment_Not_Intersecting_1D.

Section Segment_Segment_Not_Intersecting_3D.
